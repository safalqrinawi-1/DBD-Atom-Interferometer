...
class DBDEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.step_duration = pulse_duration / steps_per_episode  # Duration of each step

        # Initialize physics engine (dimensionless)
        self.physics = DBDPhysics(pulse_duration=self.pulse_duration)
